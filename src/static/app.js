          ...
          ? details.participants
              .map((participant) =>
                `<li class="participant-item">
                  ...
                  <button class="delete-participant-btn" title="Remove participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}">✖</button>
                </li>`
              )
              .join("")
          : "<li class=\"participant-item no-participants\">No students signed up yet.</li>";
